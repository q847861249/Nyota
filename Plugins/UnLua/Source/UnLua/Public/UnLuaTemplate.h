 ...
 */
template <class T, class... Args> struct TIsConstructible
{
    enum
    {
        Value = std::is_constructible_v < T,
        Args... >
    };
};
template <class T> struct TIsCopyConstructible
{
    enum
    {
        Value = std::is_copy_constructible_v<T>
    };
};
template <class T> struct TIsDestructible
{
    enum
    {
        Value = std::is_destructible_v<T>
    };
};
...
{
    template <class T1, class T2> static decltype(DeclVal<T1>() == DeclVal<T2>()) Identical(T1 *);
    template <class T1, class T2> static int32 Identical(...);
};
template <typename T1, typename T2 = T1> struct THasEqualityOperator
{
    enum
    {
        ...
        Value = TIsSame < decltype(FHasEqualityOperatorImpl::Identical<T1, T2>(nullptr)),
        bool > ::Value
#else
        Value = std::is_same_v < decltype(FHasEqualityOperatorImpl::Identical<T1, T2>(nullptr)),
        bool >
#endif
    };
};
 ...
 */
template <typename T> struct TIsConstType
{
    enum
    {
        Value = false
...
template <typename T> struct TIsConstType<const T>
{
    enum
    {
        Value = true
...
template <typename T> struct TIsConstType<const volatile T>
{
    enum
    {
        Value = true
...
template <typename T> struct TIsPrimitiveType<const T>
{
    enum
    {
        Value = TIsPrimitiveType<T>::Value
    };
};
template <typename T> struct TIsPrimitiveType<volatile T>
{
    enum
    {
        Value = TIsPrimitiveType<T>::Value
...
template <typename T> struct TIsPrimitiveType<const volatile T>
{
    enum
    {
        Value = TIsPrimitiveType<T>::Value
...
template <> struct TIsPrimitiveType<long>
{
    enum
    {
        Value = true
...
template <> struct TIsPrimitiveType<unsigned long>
{
    enum
    {
        Value = true
...
template <> struct TIsPrimitiveType<char *>
{
    enum
    {
        Value = true
...
template <> struct TIsPrimitiveType<FString>
{
    enum
    {
        Value = true
...
template <> struct TIsPrimitiveType<FName>
{
    enum
    {
        Value = true
...
template <> struct TIsPrimitiveType<FText>
{
    enum
    {
        Value = true
 ...
 */
template <typename T> struct TIsPrimitiveTypeOrPointer
{
    enum
    {
        Value = TOr < TIsPrimitiveType<T>,
        TIsPointer < T >> ::Value
    };
};
...
{
    using RT = TDecay<T>::Type;
    using Type = TChooseClass<TIsPrimitiveTypeOrPointer<RT>::Value, RT, std::remove_cv_t<T>>::Result;
};
...
template <uint32 I, typename T1, typename... T2>
struct TTupleType<I, TTuple<T1, T2...>> : TTupleType<I - 1, TTuple<T2...>>
{
};
template <typename T1, typename... T2> struct TTupleType<0, TTuple<T1, T2...>>
{
    using Type = T1;
};
...
template <uint32 M, uint32... N> struct TOneBasedIndices : TOneBasedIndices<M - 1, M, N...>
{
};
template <uint32... N> struct TOneBasedIndices<0, N...>
{
    using Type = TIndices<N...>;
};

template <uint32 M, uint32... N> struct TZeroBasedIndices : TZeroBasedIndices<M - 1, M - 1, N...>
{
};
template <uint32... N> struct TZeroBasedIndices<0, N...>
{
    using Type = TIndices<N...>;
};
 ...
 */
template <class T> struct TScriptStructTraits
{
...
template <> struct TScriptStructTraits<FQuat>
{
    static UScriptStruct *Get()
    {
        return GetScriptStructInCoreUObject(TEXT("Quat"));
    }
};
...
template <> struct TScriptStructTraits<FVector4>
{
    static UScriptStruct *Get()
    {
        return GetScriptStructInCoreUObject(TEXT("Vector4"));
    }
};
...
template <> struct TScriptStructTraits<FRandomStream>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FRandomStream>::Get();
    }
};
...
template <> struct TScriptStructTraits<FFloatRangeBound>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FFloatRangeBound>::Get();
    }
};
...
template <> struct TScriptStructTraits<FFloatRange>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FFloatRange>::Get();
    }
};
...
template <> struct TScriptStructTraits<FInt32RangeBound>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FInt32RangeBound>::Get();
    }
};
...
template <> struct TScriptStructTraits<FInt32Range>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FInt32Range>::Get();
    }
};
...
template <> struct TScriptStructTraits<FFloatInterval>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FFloatInterval>::Get();
    }
};
...
template <> struct TScriptStructTraits<FInt32Interval>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FInt32Interval>::Get();
    }
};
...
template <> struct TScriptStructTraits<FSoftClassPath>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FSoftClassPath>::Get();
    }
};
...
template <> struct TScriptStructTraits<FPrimaryAssetType>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FPrimaryAssetType>::Get();
    }
};
...
template <> struct TScriptStructTraits<FPrimaryAssetId>
{
    static UScriptStruct *Get()
    {
        return TBaseStructure<FPrimaryAssetId>::Get();
    }
};
...
template <> struct TScriptStructTraits<FDateTime>
{
    static UScriptStruct *Get()
    {
        return GetScriptStructInCoreUObject(TEXT("DateTime"));
    }
};
...
template <typename T> struct TType<T, true>
{
    static const char *GetName()
    {
